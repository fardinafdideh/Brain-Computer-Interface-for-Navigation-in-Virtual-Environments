...
## Data Aquisition (MATLAB-based Toolbox for Real-time Data Streaming in MATLAB, Visualisation, and Virtual Reality Rendering
![](/ppt/WithoutFeedback.gif)

## Subject-specific Feature and Classifier Selection (MATLAB-based Toolbox)
* Features
...
## Subject and Classifier Training (MATLAB-based Toolbox for Real-time EEG Decoding and Feedback with Virtual Reality)
![](/ppt/WithFeedback.gif)

## Virtual Reality-generated Feedback in the BCI Setup
![](/ppt/apartment.gif)
